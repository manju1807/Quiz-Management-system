                ...
                <div id="getcode" style="display: initial">
                    <form method="POST">
                        ...
                        <div class="signin">
                            ...
                            <br><br>
                            <input name="submit" class="sub" type="submit" value="Get the Code" style="height: 3vw;width: 10vw;font-family: 'Roboto', sans-serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
                    </form><br><br>
                </div>
        ...
        if ($password === $cpassword) {
            ...
            if ($res == true) {
                ...
                if ($dbmail === $username) {
                    ...
                    $mail->isHTML(true);
                    $mail->Subject = 'Reset your Quizzy password';
                    $mail->Body = '<center><div style="width:100%;background-color:#042A38;color: #fff;height:auto; "><h1>Hello ' . $dbname . '<br></h1><br>here is your security code to reset the password <h1>' . $otp . '</h1><br>  don\'t share security code with any one. <br><br><br>Thank You<br>Quizzy<br><br><a href="mailto:osesvit2021@gmail.com">Contact Us</a></div></center>';
                    if (!$mail->send()) {
